  ...
  useEffect(() => {
    const fetchSalaries = async () => {
      try {
        ...
        const response = await axios.get(`https://taddhrms-0adbd961bf23.herokuapp.com/api/salaries/employee/${employeeId}/salaries`);
              ...
              <Tr key={salary._id}>
                ...
                <Td>
                  ...
                  <Button
                    ...
                    colorScheme="blue"
                    size="sm"
                    onClick={() => navigate(`/admin/salary/deductions/${salary.employeeId}`)}
                  >
                    View Deductions
                  </Button> */}
                </Td>
